...
exec('flatc -c --scoped-enums --filename-suffix Generated --cpp-field-case-style lower --warnings-as-errors --gen-mutable --gen-object-api -o ./Sources/Game/Net/ ./protocol/*', function callback(error, stdout, stderr) {
	if (error) {
